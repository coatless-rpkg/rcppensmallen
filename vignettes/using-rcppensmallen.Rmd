...
Within `RcppEnsmallen`, the next example provides
a Linear Regression class that computes two quantities separately: 
...
Before writing the class, note that when using `RcppEnsmallen` in
a standalone C++ file, e.g. not in a package, the library is accessed using:
